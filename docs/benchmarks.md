...
This page contains comprehensive benchmark results comparing `json-pack` with other serialization libraries in the NPM ecosystem.

## Performance Overview

The `json-pack` library consistently demonstrates superior performance across various data types and sizes. For detailed benchmarking analysis and comparisons, see the [Benchmarking JSON Serialization Codecs](https://jsonjoy.com/blog/json-codec-benchmarks) blog post, which measures that `json-pack` is the fastest serialization library in the NPM ecosystem.

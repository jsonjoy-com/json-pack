...
export const getProcName = (proc: number): string => {
  switch (proc) {
    case Nfsv4Proc.NULL: return 'NULL';
    case Nfsv4Proc.COMPOUND: return 'COMPOUND';
  }
  return 'UNKNOWN(' + proc + ')';
};
...
export const getOpName = (op: number): string => {
  switch (op) {
    case Nfsv4Op.ACCESS: return 'ACCESS';
    case Nfsv4Op.CLOSE: return 'CLOSE';
    case Nfsv4Op.COMMIT: return 'COMMIT';
    case Nfsv4Op.CREATE: return 'CREATE';
    case Nfsv4Op.DELEGPURGE: return 'DELEGPURGE';
    case Nfsv4Op.DELEGRETURN: return 'DELEGRETURN';
    case Nfsv4Op.GETATTR: return 'GETATTR';
    case Nfsv4Op.GETFH: return 'GETFH';
    case Nfsv4Op.LINK: return 'LINK';
    case Nfsv4Op.LOCK: return 'LOCK';
    case Nfsv4Op.LOCKT: return 'LOCKT';
    case Nfsv4Op.LOCKU: return 'LOCKU';
    case Nfsv4Op.LOOKUP: return 'LOOKUP';
    case Nfsv4Op.LOOKUPP: return 'LOOKUPP';
    case Nfsv4Op.NVERIFY: return 'NVERIFY';
    case Nfsv4Op.OPEN: return 'OPEN';
    case Nfsv4Op.OPENATTR: return 'OPENATTR';
    case Nfsv4Op.OPEN_CONFIRM: return 'OPEN_CONFIRM';
    case Nfsv4Op.OPEN_DOWNGRADE: return 'OPEN_DOWNGRADE';
    case Nfsv4Op.PUTFH: return 'PUTFH';
    case Nfsv4Op.PUTPUBFH: return 'PUTPUBFH';
    case Nfsv4Op.PUTROOTFH: return 'PUTROOTFH';
    case Nfsv4Op.READ: return 'READ';
    case Nfsv4Op.READDIR: return 'READDIR';
    case Nfsv4Op.READLINK: return 'READLINK';
    case Nfsv4Op.REMOVE: return 'REMOVE';
    case Nfsv4Op.RENAME: return 'RENAME';
    case Nfsv4Op.RENEW: return 'RENEW';
    case Nfsv4Op.RESTOREFH: return 'RESTOREFH';
    case Nfsv4Op.SAVEFH: return 'SAVEFH';
    case Nfsv4Op.SECINFO: return 'SECINFO';
    case Nfsv4Op.SETATTR: return 'SETATTR';
    case Nfsv4Op.SETCLIENTID: return 'SETCLIENTID';
    case Nfsv4Op.SETCLIENTID_CONFIRM: return 'SETCLIENTID_CONFIRM';
    case Nfsv4Op.VERIFY: return 'VERIFY';
    case Nfsv4Op.WRITE: return 'WRITE';
    case Nfsv4Op.RELEASE_LOCKOWNER: return 'RELEASE_LOCKOWNER';
    case Nfsv4Op.ILLEGAL: return 'ILLEGAL';
  }
  return 'UNKNOWN(' + op + ')';
};
